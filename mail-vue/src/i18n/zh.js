const zh = {
    ...
    openApi: '开放 API',
    openApiDesc: '通过 API Key 暴露建邮箱、查邮件列表和取邮件内容接口',
    apiKey: 'API Key',
    apiKeyStatus: 'Key 状态',
    apiEnabled: '已配置',
    apiDisabled: '未配置',
    authHeader: '鉴权请求头',
    openApiDomains: '可用邮箱后缀',
    openApiDomainsDesc: '留空表示允许当前系统配置的全部域名',
    openApiDomainsConfig: '后缀配置',
    regenerateKey: '重新生成',
    disableKey: '停用',
    endpointList: '接口列表',
    createMailboxApi: '新建邮箱',
    listMailboxEmailsApi: '邮件列表',
    mailboxEmailContentApi: '邮件内容',
    openApiKeyTip: '新生成的 Key 只会明文展示这一次，请及时保存。',
    regenerateApiKeyConfirm: '确认重新生成 Open API Key 吗？旧 Key 会立即失效。',
    clearApiKeyConfirm: '确认停用当前 Open API Key 吗？所有开放接口会立即失效。',
    copyKey: '复制 Key',
    emailSetting: '邮件设置',
    receiveEmail: '邮件接收',
    autoRefresh: '自动刷新',
