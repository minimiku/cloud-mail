const en = {
    ...
    openApi: 'Open API',
    openApiDesc: 'Expose mailbox creation, email listing, and email content retrieval with an API key',
    apiKey: 'API Key',
    apiKeyStatus: 'Key Status',
    apiEnabled: 'Configured',
    apiDisabled: 'Not Configured',
    authHeader: 'Auth Header',
    openApiDomains: 'Available Mailbox Domains',
    openApiDomainsDesc: 'Leave empty to allow all domains configured in the system',
    openApiDomainsConfig: 'Domain Settings',
    regenerateKey: 'Regenerate',
    disableKey: 'Disable',
    endpointList: 'Endpoints',
    createMailboxApi: 'Create Mailbox',
    listMailboxEmailsApi: 'Email List',
    mailboxEmailContentApi: 'Email Content',
    openApiKeyTip: 'The new key is only shown once in plain text. Save it now.',
    regenerateApiKeyConfirm: 'Regenerate the Open API key? The old key will stop working immediately.',
    clearApiKeyConfirm: 'Disable the current Open API key? All open API endpoints will stop working immediately.',
    copyKey: 'Copy Key',
    emailSetting: 'Email',
