...
const requirePerms = [
	...
	'/setting/set',
	'/setting/query',
	'/setting/openApi/regenerate',
	'/setting/openApi/clear',
	'/user/delete',
	'/user/setPwd',
	'/user/setStatus',
	'/user/setType',
...
const premKey = {
	...
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground', '/setting/openApi/regenerate', '/setting/openApi/clear'],
